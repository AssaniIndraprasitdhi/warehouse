        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    RecurringAmount = table.Column<decimal>(type: "numeric(12,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LicenseAssignments_AspNetUsers_AssignedToId",
                        column: x => x.AssignedToId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LicenseAssignments_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRecurringCharge = table.Column<bool>(type: "boolean", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemId = table.Column<int>(type: "integer", nullable: false),
                    WithdrawnById = table.Column<string>(type: "text", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Withdrawals_AspNetUsers_WithdrawnById",
                        column: x => x.WithdrawnById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Withdrawals_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseAssignments_AssignedToId",
                table: "LicenseAssignments",
                column: "AssignedToId");

            migrationBuilder.CreateIndex(
                name: "IX_LicenseAssignments_ItemId_ReleasedAt",
                table: "LicenseAssignments",
                columns: new[] { "ItemId", "ReleasedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Withdrawals_ItemId",
                table: "Withdrawals",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Withdrawals_WithdrawnAt",
                table: "Withdrawals",
                column: "WithdrawnAt");

            migrationBuilder.CreateIndex(
                name: "IX_Withdrawals_WithdrawnById",
                table: "Withdrawals",
